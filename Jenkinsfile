        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
<<<<<<< HEAD
                        bat "echo y | pscp -i C:/Users/shres/jenkins/NorthVirgina.ppk **/target/*.war ec2-user@${params.tomcat_dev}:/var/lib/tomcat7/webapps"
=======
...
>>>>>>> parent of 4649f59... ppk
                ...
                stage ("Deploy to Production"){
                    steps {
<<<<<<< HEAD
                        bat "echo y | pscp -i C:/Users/shres/jenkins/NorthVirgina.ppk **/target/*.war ec2-user@${params.tomcat_prod}:/var/lib/tomcat7/webapps"
=======
